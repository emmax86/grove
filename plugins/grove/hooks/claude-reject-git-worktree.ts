...
import { extractClaudePreToolUseBashCommand, parseHookInput } from "./lib/hook-payload";

const payload = extractClaudePreToolUseBashCommand(parseHookInput(await Bun.stdin.text()));
